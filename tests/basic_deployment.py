...
class CephBasicDeployment(OpenStackAmuletDeployment):
    ...
    def _configure_services(self):
        ...
        if self._get_openstack_release() >= self.precise_grizzly:
            ceph_osd_config['osd-devices'] = '/dev/vdb /srv/ceph'
        else:
    ...
    def _initialize_tests(self):
        ...
        self.ceph_osd0_sentry = self.d.sentry.unit['ceph-osd/0']
    ...
    def test_services(self):
        ...
        if self._get_openstack_release() >= self.precise_grizzly:
            ...
            commands[self.ceph_osd0_sentry] = ceph_services
            commands[self.ceph_osd1_sentry] = ceph_services
            commands[self.ceph_osd2_sentry] = ceph_services
        else:
            ceph_osd0 = 'status ceph-osd id={}'.format(self._ceph_osd_id(0))
